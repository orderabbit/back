...
import com.example.back.dto.object.CommentListItem;
...
public class GetCommentListResponseDto extends ResponseDto {
    ...
    public static ResponseEntity<ResponseDto> notExistBoard() {
        ResponseDto responseBody = new ResponseDto(ResponseCode.NOT_EXISTED_BOARD, ResponseMessage.NOT_EXISTED_USER);
